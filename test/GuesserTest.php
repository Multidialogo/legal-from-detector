...
class GuesserTest extends TestCase
{
    ...
    public function provideGuessableData(): array
    {
        return [
            ...
            ['Do not match when acronym is part of other word', 'it', 'DIOMEDE SASSARI AMMINISTRATORE', null,],
            ...
            ['Do not match if DI is in the middle of the company name', 'it', 'SEMPROSIO DI SEMPROSIO', null,],
            ['Do not match when acronym is part of other word', 'it', 'SEMPROSIODI', null,],
            ['Do not match when acronym is part of other word', 'it', 'DISEMPROSIO', null,],
            ...
            ['Exact acronym match dotted version', 'it', 'SEMPROSIO D.I.', 'SOLE-PROPRIETORSHIP',],
            ['Exact acronym match partial dotted version', 'it', 'SEMPROSIO D.I', 'SOLE-PROPRIETORSHIP',],
            ['Exact acronym match version', 'it', 'SEMPROSIO DI', 'SOLE-PROPRIETORSHIP',],
